...
import './AppliedInformaticsN.css';

const AppliedInformaticsN = () => {
  return (
    <>
      <div class="information_programm1">
          ...
          < div className="name">
            <h3 className="programm1_name">Прикладная информатика для высокопроизводительных вычислительных систем</h3>
            <h3 className="programm1_number">Направление 01.04.02 “Прикладная информатика и математика”</h3>
        <hr className="line1"/> 
      

        
         <div className="time">
        <p className="time1">Срок обучения: 2 года</p>
         <p className="time2">Форма обучения: очная</p>
         </div>      
      ...
      <img src="icons/napr1_diagramma.png" alt="" className="napr1_diagramma"/></div> 
       ...
       <div className="courses">
           <p className="c">1. ПЛИС-технологии и методы создания эффективных прикладных программ для РВС</p>
           <p className="c">2. Программирование высокопроизводительных вычислительных систем  </p>
           <p className="c">3. Цифровая обработка сигналов и изображений </p>
...
export default AppliedInformaticsN;